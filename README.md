...
https://github.com/Priyanshu5437/iiitb_pipo <br/>
...
```
git clone https://github.com/Priyanshu5437/BigSpicy
cd BigSpicy/
sudo apt-get update
pip install -e ".[dev]"
...
./bigspicy.py \
   --import \
   --spef example_inputs/iiitb_pipo/iiitb_pipo.spef \
   --spice lib/sky130_fd_sc_hd.spice \
   --verilog example_inputs/iiitb_pipo/iiitb_pipo.v \
